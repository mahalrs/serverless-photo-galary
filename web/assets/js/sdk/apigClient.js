...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://fejh6lq5n2.execute-api.us-east-1.amazonaws.com/dev-v1';
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        var searchGetRequest = {
            ...
            path: pathComponent + uritemplate('/search').expand(apiGateway.core.utils.parseParametersToObject(params, ['q'])),
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['objkey', 'x-amz-meta-customLabels'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['objkey', 'x-amz-meta-customLabels']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
